<!--
  Diese Datei stellt das sichtbare Login-Formular dar.
  Sie ist ähnlich aufgebaut wie das Registrierungs-Formular.
  Bei einem Fehler (z.B. falsches Passwort) wird eine Nachricht angezeigt.
-->
<script lang="ts">
			...
			<div class="mt-6">
				<div class="relative">
					...
					<div class="relative flex justify-center text-sm">
						<span class="px-2 bg-white text-gray-500"> Noch kein Konto? </span>
					</div>
				</div>
