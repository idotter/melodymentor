	...
	<div class="max-w-5xl mx-auto">
		...
		<div class="relative bg-white p-6 sm:p-8 rounded-xl shadow-xl mb-10 overflow-hidden">
			...
			<div class="relative z-10">
				<a href="/dashboard" class="text-sm text-pink-600 hover:underline font-medium mb-2 inline-block"
		...
		<div class="bg-white p-6 rounded-lg shadow-md mb-8">
			...
			>
				...
				<div class="flex flex-col">
					<label for="audioFile" class="mb-1 font-semibold text-gray-700">Audio-Datei (MP3)</label>
					<input
						type="file"
						id="audioFile"
						name="audioFile"
