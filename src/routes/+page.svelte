...
<div class="relative min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex flex-col items-center justify-start pt-16 px-4 overflow-hidden">
	...
	<div class="absolute top-0 right-0 w-48 h-48 overflow-hidden z-50">
		<a href="/login" class="absolute block w-[200%] transform -rotate-45 bg-amber-400 text-black text-center py-2 shadow-lg hover:bg-amber-500 transition-colors duration-300 ease-in-out whitespace-nowrap" style="top: 30px; right: -60px;">
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl w-full">
		...
		<div class="flex flex-col gap-8">
			...
			<div class="bg-white p-8 rounded-xl shadow-xl self-start animate-fade-in-up animation-delay-600 w-full">
				...
				<div class="space-y-4">
					<a href="/login" class="block w-full bg-blue-600 text-white font-bold py-3 px-4 rounded-lg hover:bg-blue-700 transition-colors shadow-lg text-lg text-center">
						Login
					</a>
