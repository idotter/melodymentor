...
<div class="relative min-h-screen bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex flex-col items-center justify-start pt-16 px-4 overflow-hidden">
	<!-- Angepasstes Schräges BETA-Banner oben rechts --><div class="absolute top-0 right-0 w-48 h-48 overflow-hidden z-50 pointer-events-none">
		<!-- Der Banner-Container, nur sichtbar, wenn es auch einen Link gibt --><a href="/login" class="absolute block w-[200%] transform -rotate-45 bg-pink-600 text-white text-center py-2 shadow-lg transition-colors duration-300 ease-in-out whitespace-nowrap pointer-events-auto hover:bg-pink-700" style="top: 35px; right: -75px;">
	...
	<div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl w-full">
		...
		<!-- Rechte Spalte: Aktionen --><div class="flex flex-col gap-8">
			...
			<!-- NEUE Box: Für Lehrpersonen --><div class="bg-white p-8 rounded-xl shadow-xl self-start animate-fade-in-up animation-delay-600 w-full">
